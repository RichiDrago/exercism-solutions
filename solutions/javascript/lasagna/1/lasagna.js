...
export function remainingMinutesInOven(actualMinutesInOven) {
  ...
  if(isNaN(actualMinutesInOven)){
    throw new Error('Invalid input: actualMinutesInOven must be a number');
  }

  if(actualMinutesInOven < 0){
    throw new Error('Invalid input: actualMinutesInOven cannot be negative');
  }
...
export function preparationTimeInMinutes(numberOfLayers) {
  if(isNaN(numberOfLayers)){
    throw new Error('Invalid input: numberOfLayers must be a number');
  }

  if(numberOfLayers < 0){
    throw new Error('Invalid input: numberOfLayers cannot be negative');
  }
...
export function totalTimeInMinutes(numberOfLayers, actualMinutesInOven) {
  if(isNaN(numberOfLayers) || isNaN(actualMinutesInOven)){
    throw new Error('Invalid input: numberOfLayers and actualMinutesInOven must be numbers');
  }
  ...
  const totalTime = preparationTimeInMinutes(numberOfLayers); 
